...
public class PlaneManager 
{
    ...
    private PlaneMovement m_Movement;                        // Reference to tank's movement script, used to disable and enable control.
    private PlaneShooting m_Shooting;                        // Reference to tank's shooting script, used to disable and enable control.
