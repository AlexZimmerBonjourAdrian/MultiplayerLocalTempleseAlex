...
public class CPlayerManager : MonoBehaviour, IChange
{
    /*
    ...
    */
    ...
    void Update()
    {
        ...
        if(CKeyboard.KeysGame.PressButton(CKeyboard.KeysGame.Key1))
        {
            changedCharacter(1, 0);
        }
        else if(CKeyboard.KeysGame.PressButton(CKeyboard.KeysGame.Key2))
        {
            changedCharacter(2, 0);
        }
        else if(CKeyboard.KeysGame.PressButton(CKeyboard.KeysGame.Key3))
        {
